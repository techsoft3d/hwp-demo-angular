export class MeasureBetweenPointsOperator extends Communicator.Operator.Operator {
    private _hwv: Communicator.WebViewer;
    private _activeIndication: DistanceMarkup | null;
...
class DistanceMarkup extends Communicator.Markup.MarkupItem {
    public point1: Communicator.Point3 | null;
    public point2: Communicator.Point3 | null;

    private _hwv;
    private _isFinalized;
    private _unit;

    constructor(hwv: Communicator.WebViewer, point: Communicator.Point3 | null, unit: number) {
        super();
        this._hwv = hwv;
        this.point1 = point;
        this.point2 = null;
